...
import __string_decoder$ from "./string_decoder";
...
var Ri = (e, t, n) => (
  ...
  Ei(
    t || !e || !e.__esModule
      ? Bt(n, "default", { value: e, enumerable: !0 })
      : n,
    e
  )
);
  ...
  N(
    ...
    (...e) => {
      ...
      let t,
        n = e.length;
      switch (
        ((e = (Array.isArray(e) ? e : [e]).map((r) => `"${r}"`).join(" or ")),
        n)
      ) {
        case 1:
          t += `The ${e[0]} argument`;
...
var V = g((Jf, _n) => {
  ...
  function Io(e) {
    ...
    let t = e._writableState,
      ...
      r = t || n;
    return (
      (!r && bn(e)) || !!(r && r.autoDestroy && r.emitClose && r.closed === !1)
    );
  }
  function Mo(e) {
    var t;
      ...
      ((t =
        (n =
          (r =
            (i =
              (o =
                (l = e[an]) !== null && l !== void 0
                  ? l
                  : e.readableErrored) !== null && o !== void 0
                ? o
        ...
        async function L() {
          try {
            for await (let I of u) {
              ...
              I !== De &&
                (typeof ((_ = I) === null || _ === void 0 ? void 0 : _.catch) ==
                  "function" && I.catch(D),
                f.push(I),
                b && (b(), (b = null)),
                !h &&
  ...
  async function il(e, t, n) {
    ...
    try {
      for await (let a of this) {
        ...
        if (
          ((u = !0),
          n != null && (f = n.signal) !== null && f !== void 0 && f.aborted)
        )
          throw new $();
...
var Le = g((tu, Un) => {
  ...
  xe.prototype.pipe = function (e, t) {
    ...
    e.on("drain", i),
      !e._isStdio && (!t || t.end !== !1) && (n.on("end", l), n.on("close", u));
    let o = !1;
    function l() {
      o || ((o = !0), e.end());
    }
    ...
    return (
      n.on("end", a), n.on("close", a), e.on("close", a), e.emit("pipe", n), e
    );
  };
  function st(e, t, n) {
...
var we = g((au, dr) => {
    ...
    if (
      (i.objectMode ||
        (typeof t == "string"
          ...
          : t != null &&
            (o = new oa("chunk", ["string", "Buffer", "Uint8Array"], t))),
      o)
    )
      fe(e, o);
      ...
      i === null
        ...
        : ((t.length -= e),
          t.multiAwaitDrain
            ...
            : (t.awaitDrainWriters = null)),
      t.length === 0 &&
        (t.ended || (t.needReadable = !0), n !== e && t.ended && pt(this)),
      i !== null &&
        !t.errorEmitted &&
        !t.closeEmitted &&
  ...
  function ba(e, t) {
    if ((y("onEofChunk"), !t.ended)) {
      ...
      (t.ended = !0),
        t.sync
          ? $e(e)
          : ((t.needReadable = !1), (t.emittedReadable = !0), or(e));
    }
  }
  function $e(e) {
    let t = e._readableState;
  ...
  function je(e, t) {
    !t.readingMore &&
      t.constructed &&
      ((t.readingMore = !0), W.nextTick(_a, e, t));
  }
  function _a(e, t) {
    for (
      ;
  ...
  w.prototype.pipe = function (e, t) {
    ...
    function l(_, p) {
      y("onunpipe"),
        _ === n && p && p.hasUnpiped === !1 && ((p.hasUnpiped = !0), c());
    }
    function u() {
      y("onend"), e.end();
    }
  ...
  function pt(e) {
    ...
    y("endReadable", t.endEmitted),
      t.endEmitted || ((t.ended = !0), W.nextTick(Ea, t, e));
  }
  function Ea(e, t) {
    if (
      ...
      if (
        ((e.endEmitted = !0),
        t.emit("end"),
        t.writable && t.allowHalfOpen === !1)
      )
        W.nextTick(Ra, t);
      else if (e.autoDestroy) {
        let n = t._writableState;
        (!n || (n.autoDestroy && (n.finished || n.writable === !1))) &&
          t.destroy();
      }
    }
  }
  ...
  w.wrap = function (e, t) {
    ...
    return new w({
      objectMode:
        (n =
          (r = e.readableObjectMode) !== null && r !== void 0
            ? r
...
var Tt = g((fu, Ar) => {
  ...
  function Sr(e, t, n, r) {
    ...
    if (!i.objectMode)
      if (typeof t == "string")
        i.decodeStrings !== !1 && ((t = ve.from(t, n)), (n = "buffer"));
  ...
  function St(e, t) {
    ...
    if ((e.emit("finish"), t.autoDestroy)) {
      let r = e._readableState;
      (!r || (r.autoDestroy && (r.endEmitted || r.readable === !1))) &&
        e.destroy();
    }
  }
  ma(S.prototype, {
...
var kr = g((uu, Pr) => {
  ...
  Pr.exports = function e(t, n) {
    ...
    if (typeof t == "function") {
      ...
      if (mr(i))
        return Or(ne, i, { objectMode: !0, write: o, final: l, destroy: u });
      let f = i?.then;
  ...
  function Ge(e) {
    let t =
        e.readable && typeof e.readable.read != "function"
          ? Ja.wrap(e.readable)
          : e.readable,
      n = e.writable,
      r = !!Ha(t),
...
var Ye = g((hu, zr) => {
  ...
  function Kr(e, t, n) {
    ...
    return (
      ((i != null && i.aborted) || (o != null && o.aborted)) && He.nextTick(u),
      h
    );
  }
