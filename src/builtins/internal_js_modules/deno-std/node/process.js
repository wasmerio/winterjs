...
import { fromFileUrl, join } from "../path/mod";
import {
  arch,
  chdir,
  cwd,
  ...
  version,
  versions,
} from "./_process/process";
import { _exiting } from "./_process/exiting";
export {
...
import { processTicksAndRejections } from "./_next_tick";
...
import * as constants from "./internal_binding/constants";
import * as uv from "./internal_binding/uv";
