...
const { kMaxEventTargetListeners, kMaxEventTargetListenersWarned } =
  EventEmitter;
...
function weakListeners() {
  weakListenersState ??= new FinalizationRegistry((listener) =>
    listener.remove()
  );
...
class EventTarget extends globalThis.EventTarget {
  ...
  addEventListener(type, listener, options = {}) {
    ...
    const { once, capture, passive, signal, isNodeStyleListener, weak } =
