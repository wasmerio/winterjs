...
import { getFileInfoType, isSubdir, toPathString } from "./_util";
 ...
 * @example
 * ```ts
 * import { copy } from "https://deno.land/std@$STD_VERSION/fs/copy";
 ...
 * @example
 * ```ts
 * import { copySync } from "https://deno.land/std@$STD_VERSION/fs/copy";
