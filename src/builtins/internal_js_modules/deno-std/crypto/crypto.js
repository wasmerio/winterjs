 ...
 *
 * ```ts
 * import { crypto } from "https://deno.land/std@$STD_VERSION/crypto/mod";
 ...
 *
 * ```ts
 * import { timingSafeEqual } from "https://deno.land/std@$STD_VERSION/crypto/timing_safe_equal";
 * import { assert } from "https://deno.land/std@$STD_VERSION/testing/asserts";
 *
 * const a = await crypto.subtle.digest(
 *   "SHA-384",
 ...
 *   crypto,
 *   toHashString,
 * } from "https://deno.land/std@$STD_VERSION/crypto/mod";
 *
